...
/***/ (function(module, exports, __webpack_require__) {
	...
	var showSignIn = __webpack_require__(38);
...
/***/ (function(module, exports) {
	...
	var config = {
	  apiOrigins: {
	    production: 'https://jotaro.herokuapp.com/',
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var showMainPage = __webpack_require__(10);
	var api = __webpack_require__(30);
	var todo = __webpack_require__(31);
	var showSignIn = __webpack_require__(38);
	var getFormFields = __webpack_require__(32);
	var showSignUp = __webpack_require__(39);
	var showPasswordPage = __webpack_require__(40);

	var displayMessage = function displayMessage(errorText, errorPlace) {
	  $(errorPlace).text('');
	  $(errorPlace).show();
	...
	// events
	var onNoAccount = function onNoAccount() {
	...
	var onSignOut = function onSignOut(event) {
	  ...
	  api.signOut().then(signOutSuccess).catch(signOutFailure);
	};

	var onSignIn = function onSignIn(event) {
	  var data = getFormFields(event.target);
	  event.preventDefault();
	  api.signIn(data).then(signInSuccess).catch(signInFailure);
	};
	...
	var onSignUp = function onSignUp(event) {
	  var data = getFormFields(event.target);
	  event.preventDefault();
	  api.signUp(data).then(signUpSuccess).catch(signUpFailure);
	};

	var onBackToSignIn = function onBackToSignIn() {
	  $('#current-page').html(showSignIn);
	  signInHandlers();
	};
	...
	var onChangePassword = function onChangePassword(event) {
	  event.preventDefault();
	  var data = getFormFields(event.target);
	  api.changePassword(data).then(changePasswordSuccess).catch(changePasswordFailure);
	};

	var onGoToPasswordPage = function onGoToPasswordPage() {
	...
	// handlers
	var signUpHandlers = function signUpHandlers() {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    return "<div class=\"row\">\n  <div class=\"col-md-4 col-xs-4\">\n    <div class=\"btn-group-lg\" role=\"group\">\n      <button type=\"button\" id=\"signout\" class=\"btn btn-default\">Sign Out</button>\n      <button type=\"button\" id=\"goto-changepass\" class=\"btn btn-default\">Change Password</button>\n      <p class=\"message-text\" id=\"signout-message\"></p>\n    </div>\n  </div>\n\n  <div clas=\"col-md-6 col-xs-6\"></div>\n\n<div class=\"col-md-2 col-xs-2\"></div>\n</div>\n\n  <form id=\"item-create\" class=\"form-signin\">\n    <label>Create Item</label>\n    <input name=\"item[content]\" type=\"text\" class=\"form-control\" required=\"\" autofocus=\"\">\n    <button class=\"btn btn-default btn-block\" type=\"submit\">Create</button>\n  </form>\n\n  <!-- div to insert item index into -->\n  <div id=\"current-list\"></div>\n";
	},"useData":true});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var getFormFields = __webpack_require__(32);
	var showAllItems = __webpack_require__(33);
	var showItem = __webpack_require__(34);
	var api = __webpack_require__(35);

	var _require = __webpack_require__(36),
	    replaceCurrent = _require.replaceCurrent,
	    createItemObject = _require.createItemObject,
	    getIdFromElement = _require.getIdFromElement,
	    editFormSwap = _require.editFormSwap;
	...
	var onCreateItem = function onCreateItem(event) {
	  var content = getFormFields(event.target);
	  event.preventDefault();

	  api.itemCreate(content).then(itemCreateSuccess).catch(itemCreateFailure);
	};

	var onItemIndex = function onItemIndex() {
	  api.itemIndex().then(itemIndexSuccess).catch(itemIndexFailure);
	};

	var onEditItem = function onEditItem(event) {
	  var newContent = getFormFields(event.target);
	  var editId = getIdFromElement(event);

	  api.itemEdit(editId, newContent).then(itemEditSuccess).catch(itemEditFailure);
	};

	var onItemDestroy = function onItemDestroy(event) {
	  event.preventDefault();
	  var parentDiv = $(event.target).parents();
	  var destroyId = getIdFromElement(event);
	  $(parentDiv[2]).hide();

	  api.itemDestroy(destroyId).then(itemDestroySuccess).catch(itemDestroyFailure);
	};

	// end of stuff that shouldn't here

	// successful ajax index
	var itemIndexSuccess = function itemIndexSuccess(data) {
	  var allItemsHtml = showAllItems({ items: data.items });
	  $('#current-list').html(allItemsHtml);
	  createItemHandlers();
	};

	var itemIndexFailure = function itemIndexFailure(data) {};

	var itemDestroySuccess = function itemDestroySuccess(data) {};

	var itemDestroyFailure = function itemDestroyFailure(data) {};

	// successsful ajax post
	var itemCreateSuccess = function itemCreateSuccess(data) {
	  var showItemHtml = showItem({ item: data.item });
	  $('#current-list').append(showItemHtml);
	  createItemHandlers();
	  $('#item-create')[0].reset();
	};

	var itemCreateFailure = function itemCreateFailure(data) {};
	// succesful ajax patch
	var itemEditSuccess = function itemEditSuccess(data) {
	  var showItemHtml = showItem({ item: data.item });
	  var currentEdit = $('div').filter('.current-edit');
	  $(currentEdit).replaceWith(showItemHtml);
	  createItemHandlers();
	};

	var itemEditFailure = function itemEditFailure(data) {};

	// swamps form and adds handlers for form when edit button is clicked
	var onStartEdit = function onStartEdit(event) {
	...
	var onSaveEdit = function onSaveEdit(event) {
	  event.preventDefault();
	  onEditItem(event);
	};

	// cancels the edit and puts the todo item where the form was
	var onCancelEdit = function onCancelEdit(event) {
	  event.preventDefault();
	  replaceCurrent(event, createItemObject(event), showItem);
	  createItemHandlers();
	};

	var onClickOutCancelEdit = function onClickOutCancelEdit() {
	  event.preventDefault();
	  var toReplace = $('.current-edit')[0];
	  var replaceId = $(toReplace).attr('data-id');
	  var replaceContent = $(toReplace).attr('data-content');
	  var item = {
	    id: replaceId,
	    content: replaceContent
	  };
	  var sameItem = showItem({ item: item });
	  $(toReplace).replaceWith(sameItem);
	  createItemHandlers();
	};

	var editItemHandlers = function editItemHandlers() {
	...
	var createItemHandlers = function createItemHandlers() {
	...
	module.exports = {
	  itemIndexSuccess: itemIndexSuccess,
	  itemIndexFailure: itemIndexFailure,
	  itemDestroyFailure: itemDestroyFailure,
	  itemDestroySuccess: itemDestroySuccess,
	  itemCreateSuccess: itemCreateSuccess,
	  itemCreateFailure: itemCreateFailure,
	  itemEditSuccess: itemEditSuccess,
	  itemEditFailure: itemEditFailure,
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "\n<div class=\"item-container\" data-id=\""
	    ...
	    + "\" data-content=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.content : stack1), depth0))
	    + "\">\n\n  <div class=\"item-content\">\n    <p>\n      "
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.content : stack1), depth0))
	    + "\n      <button class=\"btn btn-default item-destroy btn-sm\">Delete</button>\n      <button class=\"btn btn-default item-edit btn-sm\">Edit</button>\n    </p>\n\n  </div>\n</div>\n\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
	    var stack1;

	  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.items : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	  ...
	  return "\n<div class=\"item-container\" data-id=\""
	    ...
	    + "\" data-content=\""
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.item : depth0)) != null ? stack1.content : stack1), depth0))
	    + "\">\n\n  <div class=\"item-content\">\n    <p>\n      "
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.item : depth0)) != null ? stack1.content : stack1), depth0))
	    + "\n      <button class=\"btn btn-default btn-sm item-destroy\">Delete</button>\n      <button class=\"btn btn-default btn-sm item-edit\">Edit</button>\n    </p>\n  </div>\n  <p id=\"item-message\"></p>\n</div>\n";
	},"useData":true});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var itemIndex = function itemIndex() {
	  return $.ajax({
	...
	var itemDestroy = function itemDestroy(id) {
	  return $.ajax({
	...
	var itemCreate = function itemCreate(content) {
	  return $.ajax({
	    method: 'POST',
	    url: config.apiOrigin + '/items',
	    headers: {
	...
	var itemEdit = function itemEdit(id, content) {
	  return $.ajax({
	    url: config.apiOrigin + '/items/' + id,
	    method: 'PATCH',
	    headers: {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var showEditform = __webpack_require__(37);
	// replaces current template with edit or item template
	var replaceCurrent = function replaceCurrent(event, item, template) {
	  var htmlToInsert = template({ item: item });
	  var parentDiv = $(event.target).parents()[2];
	  $(parentDiv).replaceWith(htmlToInsert);
	};

	// creates object to pass to handlebars template
	var createItemObject = function createItemObject(event) {
	  return {
	...
	var getIdFromElement = function getIdFromElement(event) {
	  var parentDiv = $(event.target).parents();
	  return $(parentDiv[2]).attr('data-id');
	};

	// grabs data-content from to-do item or edit form
	var getContentFromElement = function getContentFromElement(event) {
	  var parentDiv = $(event.target).parents();
	...
	var editFormSwap = function editFormSwap(event) {
	  var item = createItemObject(event);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	  ...
	  return "\n\n<div class=\"current-edit\" data-id=\""
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.item : depth0)) != null ? stack1.id : stack1), depth0))
	    + "\" data-content=\""
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.item : depth0)) != null ? stack1.content : stack1), depth0))
	    + "\">\n  <div>\n    <div class=\"form-group inline\">\n      <form class=\"item-edit-form inline\">\n        <input name=\"item[content]\" type=\"text\" class=\"form-control\" required=\"\" autofocus=\"\">\n        <button class=\"btn btn-default btn-small\" type=\"submit\">Save</button>\n      </form>\n      <button class=\"btn btn-default cancel-edit inline btn-small\">Cancel</button>\n\n    </div>\n  </div>\n</div>\n";
	},"useData":true});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function __default(obj) { return obj && (obj.__esModule ? obj["default"] : obj); }
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    return "<div class=\"sign-in-page\">\n\n  <div class=\"form-group\">\n    <form id=\"form-signin\">\n      <h2> Please sign in</h2>\n\n      <label for=\"inputEmail\" class=\"sr-only\">Email address</label>\n      <input name=\"credentials[email]\" type=\"email\" id=\"inputEmail\" class=\"form-control\" placeholder=\"Email address\" required=\"\" autofocus=\"\">\n\n      <label for=\"inputPassword\" class=\"sr-only\">Password</label>\n      <input name=\"credentials[password]\" type=\"password\" id=\"inputPassword\" class=\"form-control\" placeholder=\"Password\" required=\"\">\n\n      <button class=\"btn btn-default btn-block\" type=\"submit\">Sign In</button>\n    </form>\n  </div>\n\n\n  <button id=\"no-account\" class=\"btn btn-default\">No account? Sign up here!</button>\n  <p class=\"message-text\" id=\"signin-message\"></p>\n</div>\n";
	},"useData":true});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function __default(obj) { return obj && (obj.__esModule ? obj["default"] : obj); }
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    return "<div class=\"sign-up-page\">\n\n  <div class=\"form-group\">\n    <form id=\"form-signup\">\n      <h2> Please sign up</h2>\n\n      <label for=\"inputEmail\" class=\"sr-only\">Email address</label>\n      <input name=\"credentials[email]\" type=\"email\" id=\"inputEmail\" class=\"form-control\" placeholder=\"Email address\" required=\"\" autofocus=\"\">\n      <label for=\"inputPassword\" class=\"sr-only\">Password</label>\n\n      <input name=\"credentials[password]\" type=\"password\" id=\"inputPassword\" class=\"form-control\" placeholder=\"Password\" required=\"\">\n      <input name=\"credentials[password_confirmation]\" type=\"password\" class=\"form-control\" placeholder=\"Password Confirmation\" required=\"\">\n\n      <button class=\"btn btn-default btn-block\" type=\"submit\">Sign Up</button>\n      </form>\n    <button id=\"back-to-signin\" class=\"btn btn-default\">Already have an account?</button>\n  </div>\n  <p class=\"message-text\" id=\"signup-message\"></p>\n</div>\n";
	},"useData":true});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function __default(obj) { return obj && (obj.__esModule ? obj["default"] : obj); }
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    return "<form id=\"change-password\">\n  <h2 class=\"form-signin-heading\">Change Password</h2>\n  <label for=\"inputPassword\" class=\"sr-only\">Password</label>\n  <input name=\"passwords[old]\" type=\"password\" id=\"inputPassword\" class=\"form-control\" placeholder=\"Old password\" required=\"\">\n  <label for=\"inputPassword\" class=\"sr-only\">Password</label>\n  <input name=\"passwords[new]\" type=\"password\" id=\"inputPassword\" class=\"form-control\" placeholder=\"New Password\" required=\"\">\n  <button class=\"btn btn-default btn-block\" type=\"submit\">Change Password</button>\n  <p class=\"message-text\" id=\"password-error\"></p>\n</form>\n<button id=\"back-to-todo\" class=\"btn btn-default\">Back To List</button>\n";
	},"useData":true});
